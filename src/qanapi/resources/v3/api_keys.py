...
class APIKeysResource(SyncAPIResource):
    ...
    def revoke(
        ...
        *,
        ...
        return self._post(
            path_template("/v3/api-keys/{api_key}/revoke", api_key=api_key),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def rotate(
        ...
        *,
        ...
        """
        return self._post(
            path_template("/v3/api-keys/{api_key}/rotate", api_key=api_key),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def show(
        ...
        *,
        ...
        """
        return self._get(
            path_template("/v3/api-keys/{api_key}", api_key=api_key),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
