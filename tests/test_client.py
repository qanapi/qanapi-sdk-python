...
class TestQanapi:
    ...
    def test_copy(self) -> None:
        ...
        copied = self.client.copy(subdomain="another My-Subdomain")
        assert copied.subdomain == "another My-Subdomain"
        assert self.client.subdomain == "My-Subdomain"
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Qanapi(base_url=base_url, api_key=api_key, subdomain=subdomain, _strict_response_validation=False)
...
class TestAsyncQanapi:
    ...
    def test_base_url_trailing_slash(self, client: AsyncQanapi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncQanapi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncQanapi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncQanapi(base_url=base_url, api_key=api_key, subdomain=subdomain, _strict_response_validation=False)
    ...
    def test_get_platform(self) -> None:
        ...
        from qanapi._base_client import get_platform
